...
class Peminjaman extends CI_Controller{
	...
	public function selesai_booking($where){
		$d=$this->M_perpus->find($where,'tansaksi');
		$isi=array(
			'id_pinjam'=>$this->M_perpus->kode_otomatis(),
		...
		$data['useraktif'] = $this->M_perpus->edit_data(array('id_anggota'=>$this->session->userdata('id_anggota')),'anggota')->result();
