                  ...
                  <div class="panel panel-primary">
                    ...
                    <div class="col-lg-3">
                      <div class="panel panel-primary">
                        ...
                        <div class="col-lg-5">
                          <div class="panel panel-primary">
                            <h3 class="panel-content" style="font-size:18px;font-weight:bold;"><i class="glyphicon glyphicon-sort"></i> Peminjaman Terakhir</h3>
                            </div>
                            <div class="panel-body">
                              <div class="table-responsive">
                                <table class="tabel table-bordered tablehover table-striped" style="font-size:16px;font-weight:bold;">
                                  <thead>
                                    <tr>
                                      <th>Tgl. Transaksi</th>
                                      <th>Tgl. Pinjam</th>
