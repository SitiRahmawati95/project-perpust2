...
<a href="<?php echo base_url().'admin/tambah_buku'; ?>" class="btn btn-primary btn-xs"><span class="glyphicon-plus"></span> Buku Baru</a>
	...
	<table class="table table-bordered table-striped table-hover" id = "table-datatable">
		...
		<tbody>
			...
			<tr>
				...
				<td nowrap="nowrap">
					<a class="btn btn-primary btn-xs" href="<?php echo base_url().'admin/edit_buku/'.$b->id_buku; ?>"><span class="glyphicon glyphicon-pencil"></span></a>
